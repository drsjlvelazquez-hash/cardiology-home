      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media print {
          ...
          #print-area { position: fixed; top: 0; left: 0; width: 100%; padding: 20px 36px; }
        }
      `}</style>
        ...
        <div style={styles.topBar}>
          <div style={styles.topBarInner}>
            <div style={styles.logo}>
              ...
              <div>
                <div style={styles.logoTitle}>Heart Failure Clinic</div>
                <div style={styles.logoSub}>Diuretic Management Tool</div>
              </div>
            </div>
